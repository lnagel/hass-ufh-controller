...
1. **Flush circuit priority:** If flush is enabled and DHW is active (or recently ended) with no regular circuits currently running, flush circuits turn on to capture latent heat.
